...
class SfSNet(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.AvgPool2d(56, stride=1, padding=0)
        self.lout=nn.Linear(128,27)
        # self.lout_OULU = nn.Linear(128, 27)
    ...
    def forward(self,x):
        ...
        # print(lc1.shape)
        l0=self.l0(lc1)
        ## l0 = lc1 for classification
        ## l0 = self.l0(lc1)
        # l0 = lc1
        # print(l0.shape)

        lout=self.lout(torch.squeeze(l0))
        # lout = self.lout_OULU(torch.squeeze(l0))
        # lout = l2
        # print('Shape of lout'+str(lout.shape))
