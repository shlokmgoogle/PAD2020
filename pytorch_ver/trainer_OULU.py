...
class Model:
    ...
    def train(self):
        ...
        pretrained_weights = torch.load(
            '/vulcanscratch/shlokm/Chalearn_challenge/SFS_net_ws_exp/SFS_net_ws_exp8_OULU/SFS_net_da-92999.pth.tar')[
            'primary_net_state_dict']
        ...
        saved_models = glob.glob(
            os.path.join('/vulcanscratch/shlokm/Chalearn_challenge/SFS_net_ws_exp/SFS_net_ws_exp8_OULU/',
                         'SFS_net_da-*.pth.tar'))
        # saved_models = glob.glob(
